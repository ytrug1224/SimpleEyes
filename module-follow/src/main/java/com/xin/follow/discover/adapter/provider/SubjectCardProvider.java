...
import com.xin.follow.databinding.FollowItemSubjectCardViewBinding;
import com.xin.follow.discover.adapter.SubjectItemAdapter;
...
public class SubjectCardProvider extends BaseItemProvider<BaseCustomViewModel>
{
    ...
    public void onViewHolderCreated(@NotNull BaseViewHolder viewHolder,
        int viewType)
    {
        FollowItemSubjectCardViewBinding binding =
    ...
    {
        return R.layout.follow_item_subject_card_view;
    }
        ...
        @Nullable BaseCustomViewModel baseCustomViewModel)
    {
        ...
        FollowItemSubjectCardViewBinding binding = baseViewHolder.getBinding();
        if (binding != null)
        {
            ...
            SubjectItemAdapter adapter = new SubjectItemAdapter(
                R.layout.follow_item_category_item_subject_card_view);
