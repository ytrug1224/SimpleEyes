...
import com.xin.follow.databinding.FollowItemFollowCardViewBinding;
...
public class FollowCardProvider extends BaseItemProvider<BaseCustomViewModel>
{
    ...
    {
        return R.layout.follow_item_follow_card_view;
    }
        ...
        @Nullable BaseCustomViewModel baseCustomViewModel)
    {
        ...
        FollowItemFollowCardViewBinding binding = baseViewHolder.getBinding();
        if (binding != null)
        {
